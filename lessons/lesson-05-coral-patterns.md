# Lesson 05: Coral Patterns — Nested Loops

- **Module Reference:** Prompt 05
...
*How can the Hawksbill sea turtle (kobe ya pwani) help us learn about nested loops to make patterns?*
...
## Local Context: Hawksbill sea turtle

- **Common name:** Hawksbill sea turtle
- **Swahili name:** kobe ya pwani
- **Habitat:** coral reefs where it eats sponges and soft corals
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to nested loops to make patterns.
- **Conservation note:** critically endangered; protected by international law after historical shell trade.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Hawksbill sea turtle (kobe ya pwani). Ask a question that links the species to the coding concept: "How can we use code to coral...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (nested loops to make patterns) using a short live demo in Scratch 3. Connect every block or line of code back to the Hawksbill sea turtle.
...
Create the main deliverable: **coral or shell pattern**. Checklist:
- [ ] Core concept from the lesson is present
- [ ] Anchor species (Hawksbill sea turtle) is referenced in the project
...
- [ ] Did I use the anchor species (Hawksbill sea turtle) to make the concept memorable?
...
| Connect | Citizenship | Conservation message tied to the Hawksbill sea turtle. |
