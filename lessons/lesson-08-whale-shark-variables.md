# Lesson 08: Whale Shark Filter — Variables

- **Module Reference:** Prompt 08
...
*How can the Whale shark (papa mafia) help us learn about variables to store and update data?*
...
## Local Context: Whale shark

- **Common name:** Whale shark
- **Swahili name:** papa mafia
- **Habitat:** coastal and offshore; seasonal visitor to Kenyan waters
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to variables to store and update data.
- **Conservation note:** endangered; boat strikes and irresponsible tourism are major threats.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Whale shark (papa mafia). Ask a question that links the species to the coding concept: "How can we use code to whale...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (variables to store and update data) using a short live demo in Scratch 3. Connect every block or line of code back to the Whale shark.
...
Create the main deliverable: **whale shark measurement tracker**. Checklist:
- [ ] Core concept from the lesson is present
- [ ] Anchor species (Whale shark) is referenced in the project
...
Research one additional fact about the Whale shark and add it to the project. Alternatively, modify the code to respond to a second input or display extra data.
...
- Ages 10–13: [`quizzes/quiz-08-whale-shark-variables-10-13.md`](../../quizzes/quiz-08-whale-shark-variables-10-13.md)
- Ages 14–17: [`quizzes/quiz-08-whale-shark-variables-14-17.md`](../../quizzes/quiz-08-whale-shark-variables-14-17.md)
...
- [ ] Did I use the anchor species (Whale shark) to make the concept memorable?
...
| Connect | Citizenship | Conservation message tied to the Whale shark. |
