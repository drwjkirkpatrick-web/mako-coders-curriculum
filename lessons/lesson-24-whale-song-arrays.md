...
*How can the Humpback whale (nyangumi) help us learn about arrays/lists of sound or note data?*

## Resources

- Python + simple audio installed on learner devices (offline setup where possible)
- Projector for live demo
- Starter files or handouts as needed
- Reference material from `research/domain-reference.md`

## Local Context: Humpback whale

- **Common name:** Humpback whale
- **Swahili name:** nyangumi
- **Habitat:** breeding grounds in the Western Indian Ocean
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to arrays/lists of sound or note data.
- **Conservation note:** recovering globally but threatened by ship strikes and ocean noise.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Humpback whale (nyangumi). Ask a question that links the species to the coding concept: "How can we use code to whale...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (arrays/lists of sound or note data) using a short live demo in Python + simple audio. Connect every block or line of code back to the Humpback whale.
...
Create the main deliverable: **whale song list**. Checklist:
- [ ] Core concept from the lesson is present
- [ ] Anchor species (Humpback whale) is referenced in the project
...
- [ ] Did I use the anchor species (Humpback whale) to make the concept memorable?
...
| Code | Digital Literacy + Critical Thinking | Writing and debugging code in Python + simple audio. |
| Create | Self-efficacy | Producing a working artifact by the end of the lesson. |
| Connect | Citizenship | Conservation message tied to the Humpback whale. |
