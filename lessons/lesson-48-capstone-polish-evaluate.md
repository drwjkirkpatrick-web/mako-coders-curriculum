# Lesson 48: Capstone Build 4 — Polish & Evaluate

- **Module Reference:** Prompt 48
...
*How can the All species (viumbe vya baharini) help us learn about testing, bug fixing, and polishing?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to testing, bug fixing, and polishing.
- **Conservation note:** all marine life benefits from protected areas, clean coasts, and responsible fishing.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the All species (viumbe vya baharini). Ask a question that links the species to the coding concept: "How can we use code to refined...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (testing, bug fixing, and polishing) using a short live demo in Python + Pygame Zero. Connect every block or line of code back to the All species.
...
Create the main deliverable: **refined MVP**. Checklist:
...
- Ages 10–13: [`quizzes/quiz-48-capstone-polish-evaluate-10-13.md`](../../quizzes/quiz-48-capstone-polish-evaluate-10-13.md)
- Ages 14–17: [`quizzes/quiz-48-capstone-polish-evaluate-14-17.md`](../../quizzes/quiz-48-capstone-polish-evaluate-14-17.md)
