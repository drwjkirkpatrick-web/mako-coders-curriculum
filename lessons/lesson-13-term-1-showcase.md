# Lesson 13: Term 1 Showcase & Reflection

- **Module Reference:** Prompt 13
...
|-------------------|--------|------------|
| Computer Studies / ICT | Learning to Learn | Reflection and Portfolio |

## Learning Outcomes

By the end of the lesson the learner should be able to:
1. **Explain** explain what they learned this term.
2. **Apply** apply reflection to improve future work.
3. **Value** value continuous learning.

## Key Inquiry Question

*How can the Mixed marine life (viumbe vya baharini) help us learn about portfolio reflection and peer presentation?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to portfolio reflection and peer presentation.
- **Conservation note:** marine ecosystems support 2.7 million people; need community-led protection.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Mixed marine life (viumbe vya baharini). Ask a question that links the species to the coding concept: "How can we use code to portfolio...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (portfolio reflection and peer presentation) using a short live demo in Scratch 3. Connect every block or line of code back to the Mixed marine life.
...
Create the main deliverable: **portfolio entry**. Checklist:
...
- Ages 10–13: [`quizzes/quiz-13-term-1-showcase-10-13.md`](../../quizzes/quiz-13-term-1-showcase-10-13.md)
- Ages 14–17: [`quizzes/quiz-13-term-1-showcase-14-17.md`](../../quizzes/quiz-13-term-1-showcase-14-17.md)
