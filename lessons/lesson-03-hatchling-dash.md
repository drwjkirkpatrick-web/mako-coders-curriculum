# Lesson 03: Hatchling Dash — Sprites & Motion

- **Module Reference:** Prompt 03
...
|-------------------|--------|------------|
| Computer Studies / ICT | Algorithms | Algorithms and Programming |

## Learning Outcomes

By the end of the lesson the learner should be able to:
1. **Explain** explain the sequence of instructions.
2. **Apply** apply control structures to solve a problem.
3. **Value** value clear, ordered thinking in code.

## Key Inquiry Question

*How can the Green sea turtle (kobe ya kijani) help us learn about sprites, motion blocks, and coordinates?*
...
## Local Context: Green sea turtle

- **Common name:** Green sea turtle
- **Swahili name:** kobe ya kijani
- **Habitat:** seagrass beds and nesting beaches along the Kenyan coast
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to sprites, motion blocks, and coordinates.
- **Conservation note:** endangered; nesting beaches need darkness, quiet, and protection from plastic.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Green sea turtle (kobe ya kijani). Ask a question that links the species to the coding concept: "How can we use code to hatchling...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (sprites, motion blocks, and coordinates) using a short live demo in Scratch 3. Connect every block or line of code back to the Green sea turtle.
...
Create the main deliverable: **hatchling reaches the sea**. Checklist:
- [ ] Core concept from the lesson is present
- [ ] Anchor species (Green sea turtle) is referenced in the project
...
**Design a second scene.** Create a short Scratch animation or Python sketch that shows the Green sea turtle at a different time of day (dawn, noon, or night). Add at least one new sprite or shape and explain in one sentence why you chose that time.

## Homework Assignment

Spend 15–20 minutes at home exploring the Green sea turtle online or in a book. Write down one new fact and one question you would like to ask Mako next week. Bring your fact and question to class.

## Weekly Quiz

- Ages 10–13: [`quizzes/quiz-03-hatchling-dash-10-13.md`](../../quizzes/quiz-03-hatchling-dash-10-13.md)
- Ages 14–17: [`quizzes/quiz-03-hatchling-dash-14-17.md`](../../quizzes/quiz-03-hatchling-dash-14-17.md)
...
- [ ] Did I use the anchor species (Green sea turtle) to make the concept memorable?
...
| Connect | Citizenship | Conservation message tied to the Green sea turtle. |
