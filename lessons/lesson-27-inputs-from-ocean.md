# Lesson 27: Inputs from the Ocean

- **Module Reference:** Prompt 27
...
*How can the Mangroves (mikoko) help us learn about buttons and sensor inputs?*
...
## Local Context: Mangroves

- **Common name:** Mangroves
- **Swahili name:** mikoko
- **Habitat:** intertidal coastal forests and estuaries
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to buttons and sensor inputs.
- **Conservation note:** overharvested for charcoal and firewood; restoration protects coasts and fisheries.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Mangroves (mikoko). Ask a question that links the species to the coding concept: "How can we use code to button...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (buttons and sensor inputs) using a short live demo in micro:bit / simulator. Connect every block or line of code back to the Mangroves.
...
Create the main deliverable: **button dolphin click**. Checklist:
- [ ] Core concept from the lesson is present
- [ ] Anchor species (Mangroves) is referenced in the project
...
- Ages 10–13: [`quizzes/quiz-27-inputs-from-ocean-10-13.md`](../../quizzes/quiz-27-inputs-from-ocean-10-13.md)
- Ages 14–17: [`quizzes/quiz-27-inputs-from-ocean-14-17.md`](../../quizzes/quiz-27-inputs-from-ocean-14-17.md)
...
- [ ] Did I use the anchor species (Mangroves) to make the concept memorable?
...
| Connect | Citizenship | Conservation message tied to the Mangroves. |
