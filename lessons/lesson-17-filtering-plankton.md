# Lesson 17: Filtering the Plankton

- **Module Reference:** Prompt 17
...
*How can the Whale shark (papa mafia) help us learn about filtering and operating on lists?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to filtering and operating on lists.
- **Conservation note:** endangered; boat strikes and irresponsible tourism are major threats.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Whale shark (papa mafia). Ask a question that links the species to the coding concept: "How can we use code to filtered...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (filtering and operating on lists) using a short live demo in Python. Connect every block or line of code back to the Whale shark.
...
Create the main deliverable: **filtered diet list**. Checklist:
...
- Ages 10–13: [`quizzes/quiz-17-filtering-plankton-10-13.md`](../../quizzes/quiz-17-filtering-plankton-10-13.md)
- Ages 14–17: [`quizzes/quiz-17-filtering-plankton-14-17.md`](../../quizzes/quiz-17-filtering-plankton-14-17.md)
