# Lesson 26: Marine Data Explorer Mini-Project

- **Module Reference:** Prompt 26
...
|-------------------|--------|------------|
| Computer Studies / ICT | Data | Data and Information |

## Learning Outcomes

By the end of the lesson the learner should be able to:
1. **Explain** explain how data is stored and structured.
2. **Apply** apply data structures to model marine information.
3. **Value** value data as a tool for conservation.

## Key Inquiry Question

*How can the Mixed marine life (viumbe vya baharini) help us learn about integrating data, visuals, and interaction?*

## Resources

- Python installed on learner devices (offline setup where possible)
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to integrating data, visuals, and interaction.
- **Conservation note:** marine ecosystems support 2.7 million people; need community-led protection.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Mixed marine life (viumbe vya baharini). Ask a question that links the species to the coding concept: "How can we use code to marine...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (integrating data, visuals, and interaction) using a short live demo in Python. Connect every block or line of code back to the Mixed marine life.
...
Create the main deliverable: **marine data explorer**. Checklist:
...
- Ages 10–13: [`quizzes/quiz-26-marine-data-explorer-10-13.md`](../../quizzes/quiz-26-marine-data-explorer-10-13.md)
- Ages 14–17: [`quizzes/quiz-26-marine-data-explorer-14-17.md`](../../quizzes/quiz-26-marine-data-explorer-14-17.md)
...
| Code | Digital Literacy + Critical Thinking | Writing and debugging code in Python. |
