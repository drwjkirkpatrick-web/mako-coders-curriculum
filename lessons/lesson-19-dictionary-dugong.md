# Lesson 19: Dictionary of the Dugong

- **Module Reference:** Prompt 19
...
*How can the Dugong (dugong) help us learn about dictionaries as key-value stores?*
...
## Local Context: Dugong

- **Common name:** Dugong
- **Swahili name:** dugong
- **Habitat:** seagrass beds in shallow coastal waters
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to dictionaries as key-value stores.
- **Conservation note:** critically endangered; only 2 individuals seen in the 2023 Kenyan aerial survey.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Dugong (dugong). Ask a question that links the species to the coding concept: "How can we use code to dugong...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (dictionaries as key-value stores) using a short live demo in Python. Connect every block or line of code back to the Dugong.
...
Create the main deliverable: **dugong fact dictionary**. Checklist:
- [ ] Core concept from the lesson is present
- [ ] Anchor species (Dugong) is referenced in the project
...
Research one additional fact about the Dugong and add it to the project. Alternatively, modify the code to respond to a second input or display extra data.
...
- Ages 10–13: [`quizzes/quiz-19-dictionary-dugong-10-13.md`](../../quizzes/quiz-19-dictionary-dugong-10-13.md)
- Ages 14–17: [`quizzes/quiz-19-dictionary-dugong-14-17.md`](../../quizzes/quiz-19-dictionary-dugong-14-17.md)
...
- [ ] Did I use the anchor species (Dugong) to make the concept memorable?
...
| Connect | Citizenship | Conservation message tied to the Dugong. |
