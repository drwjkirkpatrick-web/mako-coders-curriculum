# Lesson 40: Planning the Mako Shark Expedition

- **Module Reference:** Prompt 40
...
*How can the Shortfin mako shark (papa mako) help us learn about planning a capstone project?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to planning a capstone project.
- **Conservation note:** vulnerable globally; often taken as bycatch and targeted catch.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Shortfin mako shark (papa mako). Ask a question that links the species to the coding concept: "How can we use code to Mako...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (planning a capstone project) using a short live demo in Python / Pygame Zero. Connect every block or line of code back to the Shortfin mako shark.
...
Create the main deliverable: **Mako Shark Expedition design doc**. Checklist:
...
- Ages 10–13: [`quizzes/quiz-40-planning-mako-expedition-10-13.md`](../../quizzes/quiz-40-planning-mako-expedition-10-13.md)
- Ages 14–17: [`quizzes/quiz-40-planning-mako-expedition-14-17.md`](../../quizzes/quiz-40-planning-mako-expedition-14-17.md)
