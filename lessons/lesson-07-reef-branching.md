# Lesson 07: Reef Branching — If-Else Ladders

- **Module Reference:** Prompt 07
...
*How can the Coral reefs (miamba) help us learn about multiple conditions and branching?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to multiple conditions and branching.
...
Teach the week's concept (multiple conditions and branching) using a short live demo in Scratch 3. Connect every block or line of code back to the Coral reefs.
...
Create the main deliverable: **coral health checker**. Checklist:
