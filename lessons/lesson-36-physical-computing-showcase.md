# Lesson 36: Physical Computing Showcase

- **Module Reference:** Prompt 36
...
*How can the Mixed marine life (viumbe vya baharini) help us learn about combining hardware inputs/outputs in a prototype?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to combining hardware inputs/outputs in a prototype.
- **Conservation note:** marine ecosystems support 2.7 million people; need community-led protection.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Mixed marine life (viumbe vya baharini). Ask a question that links the species to the coding concept: "How can we use code to working...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (combining hardware inputs/outputs in a prototype) using a short live demo in micro:bit / simulator. Connect every block or line of code back to the Mixed marine life.
...
Create the main deliverable: **working tide-guard station**. Checklist:
...
- Ages 10–13: [`quizzes/quiz-36-physical-computing-showcase-10-13.md`](../../quizzes/quiz-36-physical-computing-showcase-10-13.md)
- Ages 14–17: [`quizzes/quiz-36-physical-computing-showcase-14-17.md`](../../quizzes/quiz-36-physical-computing-showcase-14-17.md)
