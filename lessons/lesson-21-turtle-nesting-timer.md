# Lesson 21: Turtle Nesting Timer

- **Module Reference:** Prompt 21
...
*How can the Green sea turtle (kobe ya kijani) help us learn about state tracking and timers?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to state tracking and timers.
...
Teach the week's concept (state tracking and timers) using a short live demo in Python. Connect every block or line of code back to the Green sea turtle.
...
Create the main deliverable: **turtle nesting stage timer**. Checklist:
