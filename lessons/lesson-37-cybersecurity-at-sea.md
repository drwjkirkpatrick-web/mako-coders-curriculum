# Lesson 37: Cybersecurity at Sea

- **Module Reference:** Prompt 37
...
|-------------------|--------|------------|
| Computer Studies / ICT | Security | Cybersecurity and Ethics |

## Learning Outcomes

By the end of the lesson the learner should be able to:
1. **Explain** explain why online safety and privacy matter.
2. **Apply** apply safe password and data practices.
3. **Value** value responsible digital behaviour.

## Key Inquiry Question

*How can the All species (viumbe vya baharini) help us learn about passwords, phishing, and personal safety?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to passwords, phishing, and personal safety.
- **Conservation note:** all marine life benefits from protected areas, clean coasts, and responsible fishing.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the All species (viumbe vya baharini). Ask a question that links the species to the coding concept: "How can we use code to secure...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (passwords, phishing, and personal safety) using a short live demo in Discussion + Python. Connect every block or line of code back to the All species.
...
Create the main deliverable: **secure researcher profile**. Checklist:
