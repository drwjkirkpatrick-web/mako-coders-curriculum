# Lesson 30: Compass Dolphin

- **Module Reference:** Prompt 30
...
*How can the Spinner dolphin (pomboo) help us learn about compass heading and angles?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to compass heading and angles.
- **Conservation note:** boat noise and tourism harassment can disrupt resting pods.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Spinner dolphin (pomboo). Ask a question that links the species to the coding concept: "How can we use code to compass...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (compass heading and angles) using a short live demo in micro:bit / simulator. Connect every block or line of code back to the Spinner dolphin.
...
Create the main deliverable: **compass dolphin**. Checklist:
- [ ] Core concept from the lesson is present
- [ ] Anchor species (Spinner dolphin) is referenced in the project
...
- Ages 10–13: [`quizzes/quiz-30-compass-dolphin-10-13.md`](../../quizzes/quiz-30-compass-dolphin-10-13.md)
- Ages 14–17: [`quizzes/quiz-30-compass-dolphin-14-17.md`](../../quizzes/quiz-30-compass-dolphin-14-17.md)
...
| Connect | Citizenship | Conservation message tied to the Spinner dolphin. |
