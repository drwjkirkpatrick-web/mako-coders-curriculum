# Lesson 45: Capstone Build 1 — World & Species

- **Module Reference:** Prompt 45
...
|-------------------|--------|------------|
| Computer Studies / ICT | Project | Project Development |

## Learning Outcomes

By the end of the lesson the learner should be able to:
1. **Explain** explain the project development cycle.
2. **Apply** apply design-code-create-connect-evaluate to a capstone.
3. **Value** value creating technology with a conservation purpose.

## Key Inquiry Question

*How can the Mixed marine life (viumbe vya baharini) help us learn about building the capstone world and species?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to building the capstone world and species.
- **Conservation note:** marine ecosystems support 2.7 million people; need community-led protection.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Mixed marine life (viumbe vya baharini). Ask a question that links the species to the coding concept: "How can we use code to playable...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (building the capstone world and species) using a short live demo in Python + Pygame Zero. Connect every block or line of code back to the Mixed marine life.
...
Create the main deliverable: **playable ocean map**. Checklist:
...
- Ages 10–13: [`quizzes/quiz-45-capstone-world-species-10-13.md`](../../quizzes/quiz-45-capstone-world-species-10-13.md)
- Ages 14–17: [`quizzes/quiz-45-capstone-world-species-14-17.md`](../../quizzes/quiz-45-capstone-world-species-14-17.md)
