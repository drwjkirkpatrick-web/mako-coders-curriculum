# Lesson 51: Final Presentation Rehearsal

- **Module Reference:** Prompt 51
...
*How can the All species (viumbe vya baharini) help us learn about presentation rehearsal and demo script?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to presentation rehearsal and demo script.
- **Conservation note:** all marine life benefits from protected areas, clean coasts, and responsible fishing.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the All species (viumbe vya baharini). Ask a question that links the species to the coding concept: "How can we use code to rehearsed...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (presentation rehearsal and demo script) using a short live demo in Any tool. Connect every block or line of code back to the All species.
...
Create the main deliverable: **rehearsed presentation**. Checklist:
