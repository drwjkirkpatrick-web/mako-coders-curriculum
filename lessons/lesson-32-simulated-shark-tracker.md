# Lesson 32: Simulated Shark Tracker

- **Module Reference:** Prompt 32
- **Duration:** 2 hours (10-minute break after guided practice)
- **Age Group:** CBE Junior/Senior School (12-15 years)
- **Coding Tool:** micro:bit / simulator

## CBE Strand Mapping

| CBE Learning Area | Strand | Sub-strand |
|-------------------|--------|------------|
| Computer Studies / ICT | Networks | Networks and Communications |

## Learning Outcomes

By the end of the lesson the learner should be able to:
1. **Explain** explain how devices share data.
2. **Apply** apply simple networking code to send/receive messages.
3. **Value** value connected devices for marine research.

## Key Inquiry Question

*How can the Shortfin mako shark (papa mako) help us learn about sending and receiving coordinate data?*

## Resources

- micro:bit / simulator installed on learner devices (offline setup where possible)
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to sending and receiving coordinate data.
- **Conservation note:** vulnerable globally; often taken as bycatch and targeted catch.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Shortfin mako shark (papa mako). Ask a question that links the species to the coding concept: "How can we use code to two-device...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (sending and receiving coordinate data) using a short live demo in micro:bit / simulator. Connect every block or line of code back to the Shortfin mako shark.
...
Create the main deliverable: **two-device tracker**. Checklist:
...
- Ages 10–13: [`quizzes/quiz-32-simulated-shark-tracker-10-13.md`](../../quizzes/quiz-32-simulated-shark-tracker-10-13.md)
- Ages 14–17: [`quizzes/quiz-32-simulated-shark-tracker-14-17.md`](../../quizzes/quiz-32-simulated-shark-tracker-14-17.md)
...
| Code | Digital Literacy + Critical Thinking | Writing and debugging code in micro:bit / simulator. |
