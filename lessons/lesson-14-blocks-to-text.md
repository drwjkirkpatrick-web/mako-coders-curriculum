...
*How can the Shortfin mako shark (papa mako) help us learn about transition from Scratch blocks to Python text?*

## Resources

- Python + Turtle installed on learner devices (offline setup where possible)
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to transition from Scratch blocks to Python text.
- **Conservation note:** vulnerable globally; often taken as bycatch and targeted catch.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Shortfin mako shark (papa mako). Ask a question that links the species to the coding concept: "How can we use code to first...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (transition from Scratch blocks to Python text) using a short live demo in Python + Turtle. Connect every block or line of code back to the Shortfin mako shark.
...
Create the main deliverable: **first Python drawing**. Checklist:
...
**Translate a Scratch block.** Pick any three Scratch blocks you used in Term 1 and write the equivalent Python code.

## Homework Assignment

Install Python on a home computer or use an online Python editor. Run one print() statement and show the output.

## Weekly Quiz

- Ages 10–13: [`quizzes/quiz-14-blocks-to-text-10-13.md`](../../quizzes/quiz-14-blocks-to-text-10-13.md)
- Ages 14–17: [`quizzes/quiz-14-blocks-to-text-14-17.md`](../../quizzes/quiz-14-blocks-to-text-14-17.md)
...
| Code | Digital Literacy + Critical Thinking | Writing and debugging code in Python + Turtle. |
