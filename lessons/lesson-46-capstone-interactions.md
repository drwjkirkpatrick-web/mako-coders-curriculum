# Lesson 46: Capstone Build 2 — Interactions

- **Module Reference:** Prompt 46
...
*How can the Shortfin mako shark (papa mako) help us learn about collisions, scoring, and interactions?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to collisions, scoring, and interactions.
- **Conservation note:** vulnerable globally; often taken as bycatch and targeted catch.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Shortfin mako shark (papa mako). Ask a question that links the species to the coding concept: "How can we use code to hunt/eat/collect...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (collisions, scoring, and interactions) using a short live demo in Python + Pygame Zero. Connect every block or line of code back to the Shortfin mako shark.
...
Create the main deliverable: **hunt/eat/collect mechanic**. Checklist:
