# Lesson 47: Capstone Build 3 — Data & Conservation

- **Module Reference:** Prompt 47
...
*How can the All species (viumbe vya baharini) help us learn about displaying conservation facts and tips?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to displaying conservation facts and tips.
- **Conservation note:** all marine life benefits from protected areas, clean coasts, and responsible fishing.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the All species (viumbe vya baharini). Ask a question that links the species to the coding concept: "How can we use code to educational...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (displaying conservation facts and tips) using a short live demo in Python + Pygame Zero. Connect every block or line of code back to the All species.
...
Create the main deliverable: **educational pop-ups**. Checklist:
...
- Ages 10–13: [`quizzes/quiz-47-capstone-data-conservation-10-13.md`](../../quizzes/quiz-47-capstone-data-conservation-10-13.md)
- Ages 14–17: [`quizzes/quiz-47-capstone-data-conservation-14-17.md`](../../quizzes/quiz-47-capstone-data-conservation-14-17.md)
