# Lesson 31: Radio Tag — micro:bit Networks

- **Module Reference:** Prompt 31
...
*How can the Shortfin mako shark (papa mako) help us learn about radio messages between devices?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to radio messages between devices.
- **Conservation note:** vulnerable globally; often taken as bycatch and targeted catch.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Shortfin mako shark (papa mako). Ask a question that links the species to the coding concept: "How can we use code to shark...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (radio messages between devices) using a short live demo in micro:bit / simulator. Connect every block or line of code back to the Shortfin mako shark.
...
Create the main deliverable: **shark tag message**. Checklist:
...
**Build a sensor alarm.** Extend your micro:bit project so it reacts to two different inputs (for example, temperature + button press) and shows different LED patterns for each.

## Homework Assignment

Draw a labelled diagram of your micro:bit circuit or project idea. Label the input, the processing, and the output.

## Weekly Quiz

- Ages 10–13: [`quizzes/quiz-31-radio-tag-mako-10-13.md`](../../quizzes/quiz-31-radio-tag-mako-10-13.md)
- Ages 14–17: [`quizzes/quiz-31-radio-tag-mako-14-17.md`](../../quizzes/quiz-31-radio-tag-mako-14-17.md)
