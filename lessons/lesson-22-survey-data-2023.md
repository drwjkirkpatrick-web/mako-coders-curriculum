...
*How can the All megafauna (wanyama wakubwa wa baharini) help us learn about collecting and tabulating real data?*

## Resources

- Python / spreadsheet installed on learner devices (offline setup where possible)
- Projector for live demo
- Starter files or handouts as needed
- Reference material from `research/domain-reference.md`

## Local Context: All megafauna

- **Common name:** All megafauna
- **Swahili name:** wanyama wakubwa wa baharini
- **Habitat:** Kenyan territorial waters and pelagic Indian Ocean
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to collecting and tabulating real data.
- **Conservation note:** large marine animals need monitoring, law enforcement, and habitat protection.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the All megafauna (wanyama wakubwa wa baharini). Ask a question that links the species to the coding concept: "How can we use code to survey...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (collecting and tabulating real data) using a short live demo in Python / spreadsheet. Connect every block or line of code back to the All megafauna.
...
Create the main deliverable: **survey data table**. Checklist:
- [ ] Core concept from the lesson is present
- [ ] Anchor species (All megafauna) is referenced in the project
...
- [ ] Did I use the anchor species (All megafauna) to make the concept memorable?
...
| Code | Digital Literacy + Critical Thinking | Writing and debugging code in Python / spreadsheet. |
| Create | Self-efficacy | Producing a working artifact by the end of the lesson. |
| Connect | Citizenship | Conservation message tied to the All megafauna. |
