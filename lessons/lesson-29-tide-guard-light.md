# Lesson 29: Tide-guard Light

- **Module Reference:** Prompt 29
...
*How can the Seagrass beds (mwani wa baharini) help us learn about LED and buzzer outputs?*
...
## Local Context: Seagrass beds

- **Common name:** Seagrass beds
- **Swahili name:** mwani wa baharini
- **Habitat:** shallow coastal seabed; nursery for fish and food for turtles/dugongs
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to LED and buzzer outputs.
- **Conservation note:** threatened by salt pans, shrimp farms, sand mining, and siltation.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Seagrass beds (mwani wa baharini). Ask a question that links the species to the coding concept: "How can we use code to tide-guard...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (LED and buzzer outputs) using a short live demo in micro:bit / simulator. Connect every block or line of code back to the Seagrass beds.
...
Create the main deliverable: **tide-guard light**. Checklist:
- [ ] Core concept from the lesson is present
- [ ] Anchor species (Seagrass beds) is referenced in the project
...
- [ ] Did I use the anchor species (Seagrass beds) to make the concept memorable?
...
| Connect | Citizenship | Conservation message tied to the Seagrass beds. |
