# Lesson 16: Lists of Kenyan Marine Life

- **Module Reference:** Prompt 16
...
*How can the All species (viumbe vya baharini) help us learn about creating and indexing lists?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to creating and indexing lists.
- **Conservation note:** all marine life benefits from protected areas, clean coasts, and responsible fishing.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the All species (viumbe vya baharini). Ask a question that links the species to the coding concept: "How can we use code to marine...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (creating and indexing lists) using a short live demo in Python. Connect every block or line of code back to the All species.
...
Create the main deliverable: **marine species list**. Checklist:
...
- Ages 10–13: [`quizzes/quiz-16-lists-kenyan-marine-life-10-13.md`](../../quizzes/quiz-16-lists-kenyan-marine-life-10-13.md)
- Ages 14–17: [`quizzes/quiz-16-lists-kenyan-marine-life-14-17.md`](../../quizzes/quiz-16-lists-kenyan-marine-life-14-17.md)
