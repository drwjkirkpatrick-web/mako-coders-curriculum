# Lesson 49: User Interface and Accessibility

- **Module Reference:** Prompt 49
- **Duration:** 2 hours (10-minute break after guided practice)
- **Age Group:** CBE Junior/Senior School (15-18 years)
- **Coding Tool:** Python + Pygame Zero / web
...
*How can the All species (viumbe vya baharini) help us learn about user interface and accessibility?*

## Resources

- Python + Pygame Zero / web installed on learner devices (offline setup where possible)
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to user interface and accessibility.
- **Conservation note:** all marine life benefits from protected areas, clean coasts, and responsible fishing.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the All species (viumbe vya baharini). Ask a question that links the species to the coding concept: "How can we use code to accessible...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (user interface and accessibility) using a short live demo in Python + Pygame Zero / web. Connect every block or line of code back to the All species.
...
Create the main deliverable: **accessible dashboard**. Checklist:
...
| Code | Digital Literacy + Critical Thinking | Writing and debugging code in Python + Pygame Zero / web. |
