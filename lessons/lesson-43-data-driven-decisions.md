# Lesson 43: Data-Driven Decisions

- **Module Reference:** Prompt 43
...
*How can the All species (viumbe vya baharini) help us learn about combining data and conditionals for decisions?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to combining data and conditionals for decisions.
- **Conservation note:** all marine life benefits from protected areas, clean coasts, and responsible fishing.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the All species (viumbe vya baharini). Ask a question that links the species to the coding concept: "How can we use code to dashboard...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (combining data and conditionals for decisions) using a short live demo in Python. Connect every block or line of code back to the All species.
...
Create the main deliverable: **dashboard data panel**. Checklist:
...
- Ages 10–13: [`quizzes/quiz-43-data-driven-decisions-10-13.md`](../../quizzes/quiz-43-data-driven-decisions-10-13.md)
- Ages 14–17: [`quizzes/quiz-43-data-driven-decisions-14-17.md`](../../quizzes/quiz-43-data-driven-decisions-14-17.md)
