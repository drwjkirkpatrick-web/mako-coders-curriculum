# Lesson 38: Digital Citizenship — Clean Coasts

- **Module Reference:** Prompt 38
- **Duration:** 2 hours (10-minute break after guided practice)
- **Age Group:** CBE Junior/Senior School (12-15 years)
- **Coding Tool:** Discussion + project plan
...
*How can the Mangroves (mikoko) help us learn about using technology for environmental good?*

## Resources

- Discussion + project plan installed on learner devices (offline setup where possible)
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to using technology for environmental good.
- **Conservation note:** overharvested for charcoal and firewood; restoration protects coasts and fisheries.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Mangroves (mikoko). Ask a question that links the species to the coding concept: "How can we use code to clean-coast...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (using technology for environmental good) using a short live demo in Discussion + project plan. Connect every block or line of code back to the Mangroves.
...
Create the main deliverable: **clean-coast campaign**. Checklist:
...
| Code | Digital Literacy + Critical Thinking | Writing and debugging code in Discussion + project plan. |
