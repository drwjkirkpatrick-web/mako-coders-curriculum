# Lesson 50: Peer Review and Beta Test

- **Module Reference:** Prompt 50
- **Duration:** 2 hours (10-minute break after guided practice)
- **Age Group:** CBE Junior/Senior School (15-18 years)
- **Coding Tool:** Python + Pygame Zero

## CBE Strand Mapping

| CBE Learning Area | Strand | Sub-strand |
|-------------------|--------|------------|
| Computer Studies / ICT | Communication | Communication and Collaboration |

## Learning Outcomes

By the end of the lesson the learner should be able to:
1. **Explain** explain their project clearly.
2. **Apply** apply feedback to improve their work.
3. **Value** value collaboration with peers.

## Key Inquiry Question

*How can the All species (viumbe vya baharini) help us learn about peer testing and constructive feedback?*

## Resources

- Python + Pygame Zero installed on learner devices (offline setup where possible)
- Projector for live demo
- Starter files or handouts as needed
- Reference material from `research/domain-reference.md`

## Local Context: All species

- **Common name:** All species
- **Swahili name:** viumbe vya baharini
- **Habitat:** Kenyan coastal and marine ecosystems
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to peer testing and constructive feedback.
- **Conservation note:** all marine life benefits from protected areas, clean coasts, and responsible fishing.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the All species (viumbe vya baharini). Ask a question that links the species to the coding concept: "How can we use code to bug...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (peer testing and constructive feedback) using a short live demo in Python + Pygame Zero. Connect every block or line of code back to the All species.
...
Create the main deliverable: **bug list + fixes**. Checklist:
- [ ] Core concept from the lesson is present
- [ ] Anchor species (All species) is referenced in the project
...
**Design a second scene.** Create a short Scratch animation or Python sketch that shows the All species at a different time of day (dawn, noon, or night). Add at least one new sprite or shape and explain in one sentence why you chose that time.

## Homework Assignment

Spend 15–20 minutes at home exploring the All species online or in a book. Write down one new fact and one question you would like to ask Mako next week. Bring your fact and question to class.

## Weekly Quiz

- Ages 10–13: [`quizzes/quiz-50-peer-review-beta-10-13.md`](../../quizzes/quiz-50-peer-review-beta-10-13.md)
- Ages 14–17: [`quizzes/quiz-50-peer-review-beta-14-17.md`](../../quizzes/quiz-50-peer-review-beta-14-17.md)
...
- [ ] Did I use the anchor species (All species) to make the concept memorable?
...
| Code | Digital Literacy + Critical Thinking | Writing and debugging code in Python + Pygame Zero. |
| Create | Self-efficacy | Producing a working artifact by the end of the lesson. |
| Connect | Citizenship | Conservation message tied to the All species. |
