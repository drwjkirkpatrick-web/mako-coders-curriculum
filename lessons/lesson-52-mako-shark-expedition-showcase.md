...
*How can the All species (viumbe vya baharini) help us learn about final showcase and conservation pledge?*

## Resources

- Any tool installed on learner devices (offline setup where possible)
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to final showcase and conservation pledge.
- **Conservation note:** all marine life benefits from protected areas, clean coasts, and responsible fishing.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the All species (viumbe vya baharini). Ask a question that links the species to the coding concept: "How can we use code to Mako...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (final showcase and conservation pledge) using a short live demo in Any tool. Connect every block or line of code back to the All species.
...
Create the main deliverable: **Mako Shark Expedition demo**. Checklist:
...
| Code | Digital Literacy + Critical Thinking | Writing and debugging code in Any tool. |
