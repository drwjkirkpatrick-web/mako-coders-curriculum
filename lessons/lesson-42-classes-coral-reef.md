# Lesson 42: Classes of the Coral Reef

- **Module Reference:** Prompt 42
...
*How can the Coral reefs (miamba) help us learn about classes and objects for an ecosystem model?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to classes and objects for an ecosystem model.
- **Conservation note:** threatened by bleaching, destructive fishing, and coastal development.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Coral reefs (miamba). Ask a question that links the species to the coding concept: "How can we use code to coral...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (classes and objects for an ecosystem model) using a short live demo in Python. Connect every block or line of code back to the Coral reefs.
...
Create the main deliverable: **coral reef objects**. Checklist:
...
**New species class.** Add a second class (e.g., Fish or SeagrassPatch) with at least two attributes and one method. Make it interact with the Coral class.

## Homework Assignment

Pick three real objects in your room. For each one, list two properties and one action it can do.

## Weekly Quiz

- Ages 10–13: [`quizzes/quiz-42-classes-coral-reef-10-13.md`](../../quizzes/quiz-42-classes-coral-reef-10-13.md)
- Ages 14–17: [`quizzes/quiz-42-classes-coral-reef-14-17.md`](../../quizzes/quiz-42-classes-coral-reef-14-17.md)
