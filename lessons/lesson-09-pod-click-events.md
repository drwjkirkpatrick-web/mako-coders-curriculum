# Lesson 09: Pod Click — Events

- **Module Reference:** Prompt 09
...
*How can the Spinner dolphin (pomboo) help us learn about events such as key press and green flag?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to events such as key press and green flag.
- **Conservation note:** boat noise and tourism harassment can disrupt resting pods.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Spinner dolphin (pomboo). Ask a question that links the species to the coding concept: "How can we use code to interactive...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (events such as key press and green flag) using a short live demo in Scratch 3. Connect every block or line of code back to the Spinner dolphin.
...
Create the main deliverable: **interactive dolphin pod**. Checklist:
