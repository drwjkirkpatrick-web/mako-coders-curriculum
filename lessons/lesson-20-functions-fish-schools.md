# Lesson 20: Functions for Fish Schools

- **Module Reference:** Prompt 20
...
*How can the Mixed fish (samaki wa baharini) help us learn about defining and calling functions?*
...
## Local Context: Mixed fish

- **Common name:** Mixed fish
- **Swahili name:** samaki wa baharini
- **Habitat:** coral reefs and seagrass beds
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to defining and calling functions.
- **Conservation note:** fish stocks depend on healthy habitats and sustainable fishing.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Mixed fish (samaki wa baharini). Ask a question that links the species to the coding concept: "How can we use code to reusable...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (defining and calling functions) using a short live demo in Python + Turtle. Connect every block or line of code back to the Mixed fish.
...
Create the main deliverable: **reusable fish-school function**. Checklist:
- [ ] Core concept from the lesson is present
- [ ] Anchor species (Mixed fish) is referenced in the project
...
- [ ] Did I use the anchor species (Mixed fish) to make the concept memorable?
...
| Connect | Citizenship | Conservation message tied to the Mixed fish. |
