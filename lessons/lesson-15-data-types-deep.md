# Lesson 15: Data Types of the Deep

- **Module Reference:** Prompt 15
...
*How can the Whale shark (papa mafia) help us learn about strings, integers, floats, and booleans?*
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to strings, integers, floats, and booleans.
- **Conservation note:** endangered; boat strikes and irresponsible tourism are major threats.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Whale shark (papa mafia). Ask a question that links the species to the coding concept: "How can we use code to species...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (strings, integers, floats, and booleans) using a short live demo in Python. Connect every block or line of code back to the Whale shark.
...
Create the main deliverable: **species fact card**. Checklist:
...
- Ages 10–13: [`quizzes/quiz-15-data-types-deep-10-13.md`](../../quizzes/quiz-15-data-types-deep-10-13.md)
- Ages 14–17: [`quizzes/quiz-15-data-types-deep-14-17.md`](../../quizzes/quiz-15-data-types-deep-14-17.md)
