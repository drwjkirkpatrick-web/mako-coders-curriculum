...
*How can the Green sea turtle (kobe ya kijani) help us learn about decomposing a big task into smaller parts?*

## Resources

- Scratch 3 / paper installed on learner devices (offline setup where possible)
...
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to decomposing a big task into smaller parts.
- **Conservation note:** endangered; nesting beaches need darkness, quiet, and protection from plastic.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Green sea turtle (kobe ya kijani). Ask a question that links the species to the coding concept: "How can we use code to turtle...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (decomposing a big task into smaller parts) using a short live demo in Scratch 3 / paper. Connect every block or line of code back to the Green sea turtle.
...
Create the main deliverable: **turtle rescue flowchart**. Checklist:
...
| Code | Digital Literacy + Critical Thinking | Writing and debugging code in Scratch 3 / paper. |
