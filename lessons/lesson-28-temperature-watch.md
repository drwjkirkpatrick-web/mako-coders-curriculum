# Lesson 28: Temperature Watch

- **Module Reference:** Prompt 28
...
|-------------------|--------|------------|
| Computer Studies / ICT | Computers | Computers and Hardware |

## Learning Outcomes

By the end of the lesson the learner should be able to:
1. **Explain** explain how input and output devices work.
2. **Apply** apply sensor/output code to a micro:bit project.
3. **Value** value hardware as a way to monitor the ocean.

## Key Inquiry Question

*How can the Coral reefs (miamba) help us learn about temperature thresholds and alerts?*
...
## Local Context: Coral reefs

- **Common name:** Coral reefs
- **Swahili name:** miamba
- **Habitat:** warm shallow seas; a climate refuge exists off Kenya and Tanzania
- **Why this species:** This species anchors the week's concept because its behaviour or status connects naturally to temperature thresholds and alerts.
- **Conservation note:** threatened by bleaching, destructive fishing, and coastal development.

## Lesson Development

### Intro hook (10 min)
Share a quick fact about the Coral reefs (miamba). Ask a question that links the species to the coding concept: "How can we use code to temperature...?"

### Step 1 — Concept + teacher demo (20 min)
Teach the week's concept (temperature thresholds and alerts) using a short live demo in micro:bit / simulator. Connect every block or line of code back to the Coral reefs.
...
Create the main deliverable: **temperature warning**. Checklist:
- [ ] Core concept from the lesson is present
- [ ] Anchor species (Coral reefs) is referenced in the project
...
- Ages 10–13: [`quizzes/quiz-28-temperature-watch-10-13.md`](../../quizzes/quiz-28-temperature-watch-10-13.md)
- Ages 14–17: [`quizzes/quiz-28-temperature-watch-14-17.md`](../../quizzes/quiz-28-temperature-watch-14-17.md)
...
- [ ] Did I use the anchor species (Coral reefs) to make the concept memorable?
...
| Connect | Citizenship | Conservation message tied to the Coral reefs. |
